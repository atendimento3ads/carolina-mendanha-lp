/* LP Carolina Mendanha v2 (/v2/) — comportamento. Fica em v2/assets/app.js para ser carregado pelo mesmo bootstrap inline da página principal (hash já liberado na CSP). */
